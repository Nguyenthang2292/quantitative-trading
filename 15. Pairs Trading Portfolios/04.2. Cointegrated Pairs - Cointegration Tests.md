...
- Nếu chuỗi có gốc đơn *unit-root*, chuỗi sẽ hành xử như một *random walk* và không hồi quy về trung bình.
...
**Kiểm định Dickey-Fuller (DF Test)** *(Dickey and Fuller, 1979)* định nghĩa bài toán kiểm định giả thuyết như sau:
  ...
  Với hai giả thuyết này, một **p-value nhỏ** cho thấy chuỗi có tính dừng (bác bỏ giả thuyết $H_0$). Mô hình của *residual* có thể mở rộng để bao gồm hằng số và xu hướng tuyến tính:
