...
$$N^{\text{trades}} \times s_0 \cdot \sigma$$
...
**Lợi nhuận tổng thể là:** $$T \times \left(1 - \Phi(s_0)\right) \times s_0$$
...
# Nonparametric Data-Driven Approach - Tiếp cận dữ liệu phi tham số
...
$$s_0^* = \arg \max_{s_{0,j}} \, s_{0,j} \cdot f_j$$
