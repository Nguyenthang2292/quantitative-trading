...
<center>
<!-- $y_t = \mu + \rho y_{t-1} + \epsilon_t\$ --> <img style="transform: translateY(0.1em); background: white;" src="..\svg\hy4l4H9Oti.svg">
</center>
...
<center>
<!-- $\Delta y_t = y_t - y_{t-1}$ --> <img style="transform: translateY(0.1em); background: white;" src="..\svg\jc7kiAheap.svg">
</center>
...
- **P-value**: <!-- $\approx 3.04 \times 10^{-27}$ --> <img style="transform: translateY(0.1em); background: white;" src="..\svg\fxZtEFkuai.svg">, nhỏ hơn 0.05 <!-- $\Rightarrow$ --> <img style="transform: translateY(0.1em); background: white;" src="..\svg\3M22RHid0G.svg"> Bác bỏ giả thuyết $H_0$.
- **Kết luận**: Chuỗi `log-return` có tính dừng <!-- $\Rightarrow$ --> <img style="transform: translateY(0.1em); background: white;" src="..\svg\QNSW4dYhaV.svg"> Đây là một chuỗi *stationary* sau khi lấy sai phân bậc 1.
#### Tóm lại:
