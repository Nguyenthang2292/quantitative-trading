...
- Trong mô hình minh họa, dù chuỗi $y_{1t}$ và đồng tích hợp *(cointegration)* và có chuỗi *spread* $z_t$ ổn định, hệ số tương quan *(correlation)* giữa các sai phân của chúng vẫn rất thấp hoặc gần 0.
...
### Công thức cụ thể:
- Định nghĩa sự sai khác của chuỗi thời gian $y_t$ trong khoảng $k$ thời kỳ là: $r_t(k) = y_t - y_{t-k}$ 
