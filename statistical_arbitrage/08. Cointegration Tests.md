...
Với hai giả thuyết này, một **p-value nhỏ** cho thấy chuỗi có tính dừng (bác bỏ giả thuyết $$H_0$$).
Mô hình của phần dư có thể mở rộng để bao gồm hằng số và xu hướng tuyến tính:
