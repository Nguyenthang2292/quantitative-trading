...
### 1. Biểu đồ:
- **Biểu đồ 1 (giá đóng cửa)**: Hiển thị diễn biến giá đóng cửa của <span style="color:blue;">EUR/USD (xanh dương)</span> và <span style="color:orange">GBP/USD (cam).</span>
...
### 3. Kết luận:
Với dữ liệu giả lập này, <span style="color:red">**không có Cointegration**</span> giữa EUR/USD và GBP/USD, cho thấy rằng không tồn tại mối liên hệ dài hạn ổn định giữa hai chuỗi dữ liệu. Vì vậy, chiến lược *pairs trading* có thể không hiệu quả trong trường hợp này.
